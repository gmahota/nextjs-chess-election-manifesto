...
// core components
// import * as Button from "../CustomButtons/RegularButton";
...
export const CustomDropdown = function CustomDropdown(props: Props) {
  ...
  const handleCloseAway = (event: React.MouseEvent<HTMLButtonElement>) => {
            ...
            <Paper className={classes.dropdown}>
              <ClickAwayListener onClickAway={handleClose}>
                <MenuList role="menu" className={classes.menuList}>
                  ...
                  {dropdownList.map((prop: any, key: string) => {
                    if (prop.divider) {
                      return (
                        <Divider
                          key={key}
